...
- Run: `2026-06-06_increment-5-widget-and-panel_1137`
...
| Gate | Status | Detail |
| --- | --- | --- |
| plan-check | FAIL | [Errno 2] No such file or directory: 'runs\\2026-06-06_increment-5-widget-and-panel_1137\\artifacts\\plan-check-result.json' |
