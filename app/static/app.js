...
import { createWorkspaceCompatibilityRuntime } from "./modules/workspace-compatibility-runtime.js";
...
document.addEventListener("DOMContentLoaded", () => {
   ...
   */
  const workspaceCompatibilityRuntime = createWorkspaceCompatibilityRuntime({
    CONTEXT_LINK_MODES,
    WORKSPACE_CONTEXT_MODEL_VERSION,
    WORKSPACE_OBJECT_TYPES,
    DASHBOARD_GRID_ROW_HEIGHT,
    ...
    isPanelInternalWidgetLayout,
    panelForInternalWidgetLayout,
    widgetLayerForElement: (...args) => widgetLayerForElement(...args),
    isEngineerMode,
    refreshWidgetRuntimeData: (...args) => refreshWidgetRuntimeData(...args),
    ensureWorkspaceObjectMetadata,
    gridHostForLayout,
    visualGridOrder: (...args) => visualGridOrder(...args),
    globalGridItems: (...args) => globalGridItems(...args),
  ...
  refreshWorkspaceMiniMaps = workspaceCompatibilityRuntime.refreshWorkspaceMiniMaps;
  const {
  ...
  const { savePanelLayouts } = createPanelLayoutSaveRuntime({
    getActivePanelProfile,
    syncWorkspaceRegions,
    pushLiveLayoutUndo,
    captureLayoutUndo,
    expansionBaselineSnapshotForLayoutKey: (...args) => expansionBaselineSnapshotForLayoutKey(...args),
    serializableExpansionBaselineState: (...args) => serializableExpansionBaselineState(...args),
    gridItemRowSpan,
    writeJsonStore,
    panelStorageKey,
    serializePanelChildWidgets: (...args) => serializePanelChildWidgets(...args),
    workspaceObjectPersistence,
    customPanelsKey,
    writeRawStore,
    hiddenPanelsKey,
  ...
  const {
  ...
  } = createWidgetCompatibilityRuntime({
    activeLayoutKeyForItem,
    assetById,
    assetSourceRef,
    createAssetFromSource,
    ...
    mediaWidgetAssetTypes,
    readableTextFor,
    renderWidgetRuntimeContent: (...args) => renderWidgetRuntimeContent(...args),
    resolveWorkspaceContextForItem,
    widgetConfigFromElement: (...args) => widgetConfigFromElement(...args),
    widgetDefinitionForElement: (...args) => widgetDefinitionForElement(...args),
    widgetRuntimeTypeFromElement: (...args) => widgetRuntimeTypeFromElement(...args),
  });
  const {
  ...
  const { saveWidgetLayouts } = createWidgetLayoutSaveRuntime({
    getActivePanelProfile,
    isPanelInternalWidgetLayout,
    panelForInternalWidgetLayout,
    syncOpenPanelHeightToInternalGrid,
